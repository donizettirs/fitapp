...
day_group = st.sidebar.selectbox("Selecione (GRUPO):", options=df['GRUPO'].unique())

# Sidebar Inputs for Timer
st.sidebar.title("Nº de séries | Intervalo")
